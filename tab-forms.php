    ...
    <div class="tab-content">
        <div id="tab_info" class="tab-pane active">
            <div style="width: 35%; padding: 10px 30px 0 0; float: left; margin-left: 20px;">
                ...
                <input type="text" id="guests" name="bookinglink" placeholder="Enter Affiliated booking links" class="regular-text"><br><br>
            </div>
        ...
        <div id="tab_pricing" class="tab-pane">
            ...
            <label for="booking" class="feature-label">After price label:</label><br>
            ...
            <select id="weekendprice" name="weekendprice" class="regular-text">
                ...
                <option value="Daily">Friday and Saturday</option>
                <option value="weekly">Weekly</option>
                <!-- Add more options as needed -->
            </select><br><br>

            <hr><br>
            <label>Long-Term Pricing</label>
            <hr>
        ...
        <div id="tab_location" class="tab-pane">
            ...
            <label for="featured-yes">
                <input type="radio" id="featured-yes" name="featured" value="show"> Show
            </label>
            <label for="featured-no">
                <input type="radio" id="featured-no" name="featured" value="hide"> Hide
            </label><br>
...
<input type="submit" name="submit" value="Add Info" class="button button-primary" style="padding: 5px 10px;">
